...
public class NewStoreInsertPageController implements Initializable {
    public TextField store_search_text_field;
    public Button search_button;
    public JFXListView search_store_result_list;
    public Button new_store_insert;
            ...
            thisStore.selectedProperty().addListener(new ChangeListener<Boolean>() {
                ...
                public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
                    if(newValue) {
                        ...
                        new_store_insert.setOnAction(new EventHandler<ActionEvent>() {
                            @Override
                            public void handle(ActionEvent event) {
                                if(event.getEventType() == ActionEvent.ACTION) {
    ...
    public void insertUltraStore(int storeId) {
        ...
        if(GetBool.getBool(ConnectToServer.Post("NewStoreInsert.do", jsonObject))) {
